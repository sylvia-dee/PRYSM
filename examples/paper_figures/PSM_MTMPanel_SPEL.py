...
# Speleothems (Hidden Cave) [=element 7]

cd /home/geovault-02/sdee/Forward_Modeling_Toolbox/Speleothem_Development/PRYSM
T=np.load('cave_network_T_1000_2005.npy')
P=np.load('cave_network_P_1000_2005_ALL.npy')
d18Op=np.load('cave_network_PISO_1000_2005.npy')
d18Os=np.load('cave_network_SISO_1000_2005_ALL.npy')
cd /home/geovault-02/sdee/Forward_Modeling_Toolbox/Speleothem_Development

#d18Oc=np.load('BORNEO_PDRIP_T_1.npy')
# check
cd /home/geovault-02/sdee/Forward_Modeling_Toolbox/Speleothem_Development/PRYSM
d18Oc_all=np.load('CAVE_NETWORK_DRIP_T_1.npy')
...
#Sd18Oc=d18Oc_all[:,6]
cd /home/geovault-02/sdee/Forward_Modeling_Toolbox/Speleothem_Development
Sd18Oc=np.load('HIDDEN_PDRIP_T_1.npy')
#======================================================================================
...
cd /home/geovault-02/sdee/Forward_Modeling_Toolbox/Speleothem_Development/PRYSM
Bchron=np.load('BCHRON_Hidden.npy').T
