...
# Ice Cores (Quelccaya, Peru) [=element1]
cd /home/geovault-02/sdee/Forward_Modeling_Toolbox/Ice_Development/PRYSM
T=np.load('ice_network_T_1000_2005.npy')
P=np.load('ice_network_PA_1000_2005.npy')
d18Op=np.load('ice_network_ISO_1000_2005.npy')
cd /home/geovault-02/sdee/Forward_Modeling_Toolbox/Ice_Development/PAGES_OR
d18Oi=np.load('quel_archive_1000_2005.npy')
...
Xp=np.load('QUEL_BAM_realiz.npy')
