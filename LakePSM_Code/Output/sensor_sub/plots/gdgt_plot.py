...
# Russell et al., 2018
gdgt_proxy_mbt = np.load('gdgt_sensor.npy')
to_plot(gdgt_proxy_mbt, 'gdgt (Russell et al., 2018)', 'unit', monthly_ave = False)
to_plot(gdgt_proxy_mbt, 'gdgt (Russell et al., 2018)', 'unit', monthly_ave = True)